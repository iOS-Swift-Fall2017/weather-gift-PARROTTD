...
class PageVC: UIPageViewController {
    ...
    func loadLocations(){
        guard let locationsEncoded = UserDefaults.standard.value(forKey: "locationsArray") as? Data else {print("could not load default locations")
            return
        }
        ...
        else { print("coudl not decode data read from user defaults")
        }
    }
...
extension PageVC: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    @objc func pageControlPressed() {
        ...
        } else if currentPage > currentViewController.currentPage {
